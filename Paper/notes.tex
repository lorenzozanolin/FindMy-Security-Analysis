...
% monitoraggio remoto, solo come intrusion detector, wallet trcker (piu i wallet fatti apposta), remote tracking di persone nel caso si splittino (es. ad un concerto) e ci sia poca connessione internet (cosi non serve chiamarsi), drone tracking, localizzare gli scaffali nei supermercati (idea possibile se le API sono aperte)
