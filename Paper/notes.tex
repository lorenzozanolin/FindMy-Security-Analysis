...
Each report contains an EC public key $p_i$. When a finder device receives a report, it saves its location and encrypts it using the $p_i$ key; Subsequently, it uploads the packet to Apple's servers.
